...
<%
	...
	if(cookies!=null){
		for(Cookie c:cookies){
			if(c.getName().equals("remusername")){		
 ...
 %>
	...
	<div id="divcontent">
		<form action="loginservlet?returl=${param.returl }" method="post">
							...
							<div>
								<table width="85%" border="0" cellspacing="0">
									<tr>
															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	<td colspan="2" style="text-align:center"><input
																		type="checkbox" name="remusername" value="checkbox" />
																		记住用户名&nbsp;&nbsp; <input type="checkbox"
																		name="autologin" value="checkbox" /> 自动登录</td>
																</tr>
																<tr>
																	<td colspan="2"
										...
										<td style="text-align:left; padding-top:30px;padding-left:100px; width:60%"><h1>您还没有注册？</h1>
											<p>注册新会员，享受更优惠价格!</p>
